...
Install and sign into Tailscale on both PCs, using the same Tailscale network. In RGC AI Broadcast Studio, set **Remote Producer Assist Access** to `0.0.0.0`, save settings, start the broadcast, then copy the Producer Assist Link and send it to the helper.
