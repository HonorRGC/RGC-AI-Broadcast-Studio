...
Both PCs must be signed into the same Tailscale network. In the Studio, set `Remote Producer Assist Access` to `0.0.0.0`, save settings, start the broadcast, then copy/send the **Remote Helper Link**.
