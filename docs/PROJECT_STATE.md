...
- Producer Assist control room with driver list, selected-driver details, race focus, director suggestions, pit-road strategy, broadcast notes, camera controls, and show controls
- League profiles, Sim Racer Hub and Velocity imports, separate season/career stats CSVs, driver stories, sponsor reads, stage laps, and post-race interview handoff
