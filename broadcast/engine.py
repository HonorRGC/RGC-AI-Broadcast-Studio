...
class BroadcastEngine:
    ...
    def green_pit_cycle_update_messages(self, pitted_count, track_info):
        if is_true_pack_drafting_track(track_info):
            return [
                f"Pit road has {pitted_count} cars logged with recent green flag stops. The key now is whether they blend back into help or get stranded between packs.",
        ...
        if is_long_straight_draft_assist_track(track_info):
            return [
                f"Pit road has {pitted_count} recent stops logged. The timing can briefly change the lead, but the real answer comes once everyone is back at speed.",
        ...
        if is_road_course(track_info):
            return [
                f"Pit road has {pitted_count} cars logged with recent stops. The undercut and out-lap traffic are the big pieces to watch here.",
        ...
        return [
            ...
            f"Pit road has {pitted_count} cars logged with recent stops. The question now is whether fresh tires beat the longer run.",
