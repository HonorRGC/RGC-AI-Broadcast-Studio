...
VELOCITY_LEAGUE_URL = os.getenv("VELOCITY_LEAGUE_URL", "").strip()
...
SIMRACERHUB_SEASON_ID = os.getenv("SIMRACERHUB_SEASON_ID", "").strip()
...
_LEGACY_SPONSOR_READ_CAUSE = os.getenv("SPONSOR_READ_CAUSE", "").strip()
SPONSOR_READ_CAUSE_NAME = os.getenv(
    "SPONSOR_READ_CAUSE_NAME",
    _LEGACY_SPONSOR_READ_CAUSE,
).strip()
SPONSOR_READ_CAUSE = SPONSOR_READ_CAUSE_NAME
SPONSOR_READ_CAUSE_READ = os.getenv("SPONSOR_READ_CAUSE_READ", "").strip()
...
STARTING_LINEUP_SPONSOR_NAME = os.getenv("STARTING_LINEUP_SPONSOR_NAME", "").strip()
STARTING_LINEUP_SPONSOR_LOGO = os.getenv("STARTING_LINEUP_SPONSOR_LOGO", "").strip()
STARTING_LINEUP_SPONSOR_READ = os.getenv("STARTING_LINEUP_SPONSOR_READ", "").strip()
FINAL_RESULTS_SPONSOR_NAME = os.getenv("FINAL_RESULTS_SPONSOR_NAME", "").strip()
FINAL_RESULTS_SPONSOR_LOGO = os.getenv("FINAL_RESULTS_SPONSOR_LOGO", "").strip()
FINAL_RESULTS_SPONSOR_READ = os.getenv("FINAL_RESULTS_SPONSOR_READ", "").strip()
CAUTION_REVIEW_SLATE_SPONSOR_NAME = os.getenv("CAUTION_REVIEW_SLATE_SPONSOR_NAME", "").strip()
CAUTION_REVIEW_SLATE_GRAPHIC = os.getenv("CAUTION_REVIEW_SLATE_GRAPHIC", "").strip()
